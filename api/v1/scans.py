...
def forensic_pdf_status(
    ...
    # Check if PDF exists in S3 already by attempting to generate a presigned URL.
    # If the key doesn't exist, boto3 still issues a URL but the download will 404.
    # A robust check would be a HeadObject call; simplified here.
