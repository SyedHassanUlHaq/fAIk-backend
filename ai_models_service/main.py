...
async def lifespan(app: FastAPI):
    print("[*] Loading AI models (scene/tamper detection) at startup...")
    ...
    yield
    print("[*] AI models service shutdown")


app = FastAPI(title="fAIk AI Models Service", version="1.0", lifespan=lifespan)
...
@app.get("/")
def root():
    return {"message": "fAIk AI Models Service running", "version": app.version}
